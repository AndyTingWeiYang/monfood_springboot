...
public class PairListServiceImpl implements PairListService {
	...
	// 取好友名單ID並取出資料
	public List<UserVOTemp> findFriends(Integer useraId) {
		// 要拿到的list
		List<UserVOTemp> listUserVO = new ArrayList<UserVOTemp>();
		UserVOTemp userVO = null;
	...
	// 取得當日配對者ID並取出資料
	public List<UserVOTemp> findPairInfo(Integer useraId, java.sql.Date pairedDate) {
		List<UserVOTemp> listUserVO = new ArrayList<UserVOTemp>();
		UserVOTemp userVO = null;
